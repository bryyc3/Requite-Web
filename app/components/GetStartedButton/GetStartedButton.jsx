    ...
    return(
        <div className="mt-[1cqi] ">
            <div className="relative inline-flex p-[2px] rounded-full group">
                ...
                <button className="cursor-pointer relative z-[2] px-8 py-1 text-black font-semibold rounded-full transition-all duration-300 group-hover:shadow-[1px_1px_8px_#f69400] text-[1.4cqi]">
                    Get Started
                </button>
            </div>
        </div>
