        ...
        <div className="min-h-screen grid grid-cols-2 bg-gradient-to-t from-orange-400 to-orange-600">
            <div className="bg-white rounded-r-[10vw] md:rounded-r-[5vw] shadow-2xl transition-all duration-300 shadow-[18px_25px_20px_rgba(0,0,0,0.55)]">
                <div className="pl-40 pt-70">
                    ...
                    <h2 className="bg-gradient-to-b from-orange-600 to-orange-400 bg-clip-text text-transparent text-[23px] w-100 text-center underline">Continue with email</h2>
                </div>
            </div>
            <div className="flex-1 relative">
                <div className="absolute top-8 right-8">
                    <Link  href= "/" className="bg-gradient-to-r from-gray-200 to-gray-300 bg-clip-text text-transparent font-bold text-[50px]">Requite</Link>
                </div>
