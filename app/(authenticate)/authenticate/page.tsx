            ...
            <div className="bg-white rounded-r-[10vw] md:rounded-r-[5vw] shadow-2xl transition-all duration-300 shadow-[18px_25px_20px_rgba(0,0,0,0.55)]">
                <div className="pl-40 pt-70">
                    ...
                    <div className="pt-15 flex flex-col items-center w-fit">
                        ...
                        <h2 className="w-fit bg-gradient-to-b from-orange-600 to-orange-400 bg-clip-text text-transparent text-[clamp(1rem,.7vw+1rem,2rem)] w-100 text-center underline">Continue with email</h2>
                    </div>
                </div>
            </div>
            <div className="flex-1 relative">
                ...
                <div className="h-full flex justify-center">
                        <div className="text-center pt-50 w-full">
                            <p className="text-white text-[clamp(.7rem,.7vw+1rem,2rem)]">Access your dashboard from <b>anywhere!</b> <br /> Dowload our mobile app</p>
                        </div>
                </div>
            </div>
        </div>
