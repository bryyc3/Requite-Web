        ...
        <div className="flex justify-between w-full p-10 items-center">
            <div className="flex gap-3 items-center justify-center">
                ...
                <div className="leading-tight">
                    ...
                    <h2 className="font-light text-xl">Location</h2>
                </div>
            </div>
            <div className="text-center">
                <h1 className="font-light text-2xl">Loyalty Member Count</h1>
                <h2 className="font-bold text-xl">44675</h2>
            </div>
            <div className="mt-[1cqi]">
            <div className="relative inline-flex p-[5px] rounded-full group">
                <div className="absolute inset-0 rounded-full bg-gradient-to-r from-orange-500 via-orange-400 to-orange-300" />
                    <button href="/dashboard" className="cursor-pointer relative z-[2] px-8 py-1 text-black font-semibold rounded-full text-xl">
                        Send Free Reward
                    </button>
                </div>
            </div>
