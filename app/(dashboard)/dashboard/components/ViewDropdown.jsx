...
export default function ViewDropdown() {
  ...
  return (
    <div ref={ref} className="absolute left-1/2 -translate-x-1/2 md:block">
      <button onClick={() => setOpen(!open)} className="inline-flex items-center justify-center px-4 py-1 bg-gray-300 text-black rounded-md font-extralight">
        Dashboard
      ...
      <div
        ...
        <a className="block px-4 py-2 hover:bg-gray-100">Preview</a>
      </div>
    </div>
  );
}