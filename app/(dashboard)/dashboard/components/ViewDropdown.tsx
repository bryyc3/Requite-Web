...
export default function ViewDropdown() {
  ...
  return (
    <div ref={ref}>
      ...
      <div className={`absolute mt-2 w-48 bg-white rounded-md shadow-lg transition-all duration-200 ${open ? "opacity-100 scale-100" : "opacity-0 scale-95 pointer-events-none"}`}>
